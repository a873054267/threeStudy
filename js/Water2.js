...
THREE.Water = function ( geometry, options ) {
	...
	var waterPath = options.waterPath || ["../../images/ysThree/water/Water_1_M_Normal.jpg","../../images/ysThree/water/Water_2_M_Normal.jpg"]

	var textureLoader = new THREE.TextureLoader();

	var flowMap = options.flowMap || undefined;
	var normalMap0 = options.normalMap0 || textureLoader.load( waterPath[0] );
	var normalMap1 = options.normalMap1 || textureLoader.load( waterPath[1] );
